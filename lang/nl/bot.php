...
return [
    ...
    */
    ...
    'set' => [
        ...
        'usage-set' => 'Gebruik: set `setting_key` `setting_value`',
    ...
    'messages' => [
        'title' => 'xp- en niveaustatistieken',
    ...
    'reactions' => [
        ...
        'footer' => 'gebruik: addreaction, delreaction, reactions',
        'title' => 'Reacties',
    ...
    'mentiongroup' => [
        ...
        'footer' => 'Lijst van vermeldingsgroepen',
        'description' => ':data',
