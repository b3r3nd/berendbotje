...
class Leaderboard extends SlashIndexCommand
{
    ...
    public function getEmbed(): Embed
    {
        ...
        $description = "";
        foreach (\App\Models\MessageCounter::byGuild($this->guildId)->orderBy('xp', 'desc')->skip($this->getOffset($this->getLastUser()))->limit($this->perPage)->get() as $index => $messageCounter) {
